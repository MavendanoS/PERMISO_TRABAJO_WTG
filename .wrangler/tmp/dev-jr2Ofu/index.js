...
// .wrangler/tmp/bundle-tGqBvl/checked-fetch.js
  ...
  return `
    ...
    function validatePasswordStrength(password) {
      ...
      if (!hasSpecialChar) {
        return { 
          valid: false, 
          message: 'La contrase\xF1a debe contener al menos un car\xE1cter especial (!@#$%^&*()_+-=[]{};':"|,.<>/?)' 
        };
      }
...
// .wrangler/tmp/bundle-tGqBvl/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-tGqBvl/middleware-loader.entry.ts
