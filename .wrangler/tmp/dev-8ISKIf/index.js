...
// .wrangler/tmp/bundle-Dg2cIe/checked-fetch.js
...
async function handlePermisoDetalle(request, corsHeaders, env, currentUser, services) {
  ...
  try {
    ...
    const materialesResult = await env.DB_PERMISOS.prepare(`
      SELECT * FROM permiso_materiales WHERE permiso_id = ?
    `).bind(permisoId).all();
...
// .wrangler/tmp/bundle-Dg2cIe/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Dg2cIe/middleware-loader.entry.ts
